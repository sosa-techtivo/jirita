...
function SelectField({ value }: { value: string }) {
  return (
    <button className="flex items-center gap-2 text-[13px] text-slate-700 dark:text-zinc-300 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-700 rounded-lg px-2.5 py-1.5 hover:bg-slate-50 dark:hover:bg-zinc-800 transition-colors min-w-[160px] justify-between">
      {value}
...
function TextField({ value, width = "w-52" }: { value: string; width?: string }) {
  return (
    <input
      type="text"
      defaultValue={value}
      className={`text-[13px] text-slate-800 dark:text-zinc-200 bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-700 rounded-lg px-2.5 py-1.5 outline-none focus:border-brand-500 dark:focus:border-brand-400 ${width}`}
    />
  );
}

function NumberField({ value, suffix }: { value: number; suffix?: string }) {
  return (
    <div className="flex items-center gap-2">
      <input
        type="number"
        defaultValue={value}
        className="text-[13px] text-slate-800 dark:text-zinc-200 bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-700 rounded-lg px-2.5 py-1.5 outline-none focus:border-brand-500 dark:focus:border-brand-400 w-20 text-center"
      />
