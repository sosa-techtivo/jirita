...
export const TAG_CLASS: Record<string, string> = {
  Decision: "bg-brand-50 text-brand-700 dark:bg-brand-accent/10 dark:text-brand-accent",
...
// `text-[16px] sm:text-[13px]` (not a flat 13px) — iOS Safari auto-zooms on
// focus for any input whose effective font-size is below 16px; 16px on
// Mobile avoids that without touching the viewport meta. `sm:` keeps
// Desktop/Tablet's exact original 13px. Same technique as
// components/auth/field-styles.ts's INPUT.
export const INPUT =
