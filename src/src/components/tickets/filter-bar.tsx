      ...
      <div className="flex items-center gap-1 flex-wrap">
        ...
        <label className="relative block w-full sm:w-auto">
          ...
          <input
            ...
            className="w-full sm:w-64 text-[16px] sm:text-sm bg-slate-100 dark:bg-zinc-900 placeholder:text-slate-400 dark:placeholder:text-zinc-500 text-slate-800 dark:text-zinc-100 rounded-md pl-8 pr-3 py-1.5 outline-none focus:ring-2 focus:ring-brand-500/30 transition-colors dark:focus:ring-brand-accent/30"
          />
        </label>
