  ...
  return (
    <label className="inline-flex items-center gap-1.5 text-xs">
      ...
      <select
        ...
        className="rounded-md border border-slate-200 bg-slate-50 text-slate-600 text-[16px] sm:text-xs font-medium px-2 py-1 outline-none focus:ring-2 focus:ring-brand-500/30 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:focus:ring-brand-accent/30"
      >
        {ROLES.map((role) => (
