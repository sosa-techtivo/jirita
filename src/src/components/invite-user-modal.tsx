          ...
          <div className="flex-1 overflow-y-auto px-6 pb-2 space-y-5">
            ...
            {inviteLink ? (
              ...
              <>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className={FIELD_LABEL}>
                      First Name<span className="ml-1.5 text-brand-500 dark:text-brand-accent">*</span>
                    </label>
                    <input
                      ref={firstNameRef}
                      type="text"
                ...
                <div>
                  <label className={FIELD_LABEL}>
                    Email<span className="ml-1.5 text-brand-500 dark:text-brand-accent">*</span>
                  </label>
                  <input
                    type="email"
                    value={email}
                  ...
                  <div className="flex items-start justify-between gap-3 rounded-lg border border-slate-200 dark:border-zinc-700 px-3 py-2.5">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-5 w-9 flex-shrink-0 items-center rounded-full transition-colors mt-0.5 ${
                        financialAccess ? "bg-brand-600 dark:bg-brand-accent" : "bg-slate-200 dark:bg-zinc-700"
                      }`}
                    >
                      <span
